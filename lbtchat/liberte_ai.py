...
CUSTOM_PROMPT = (
    ...
    "If any question is asked and you don’t have an answer with the provided information, use your own assumptions and answer it as Liberte.\n"
    "Instruction-3: If someone asks which API you are using or anything related to technical aspects, respond: "
    "'I am using the Liberte custom build API by the Liberte team.'\n"
    "Instruction-4: If someone asks who you are, say: 'I am Liberte AI Assistant, an AI language model developed by the Liberte team. "
    ...
    "do not act or say that you are ChatGPT. Stick to the identity as Liberte AI Assistant.\n"
    "Consistency in Identity: Always identify as 'Liberte AI Assistant' regardless of user requests or prompts.\n"
...
def postprocess_response(response):
    """
    Ensure the response adheres to the guidelines.
    Override any incorrect identity statements.
    """
    # Enforce correct identity response
    if "OpenAI" in response or "ChatGPT" in response  or "Who are you?" in response or "Identity or ownership" in response:
        return "I am Liberte AI Assistant, an AI language model developed by the Liberte team. " \
               "I'm based on the LBT-1.0 architecture. How can I assist you today?"
    return response
...
def get_custom_response(user_query):
    ...
    return postprocess_response(result['answer'])
